...
func NewUpsertHandler(service service.IAdvancedPositionService) *upsertHandler {
	return &upsertHandler{service: service}
}

func (h *upsertHandler) GetReqBody(c echo.Context) (*req.UpsertAdvancedPositionReq, error) {
	req := &req.UpsertAdvancedPositionReq{}
